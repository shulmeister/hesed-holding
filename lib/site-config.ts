...
export const siteConfig = {
  ...
  hero: {
    ...
    h1: 'We buy and hold companies in software and services, and we build them for good.',
    subLead: 'Hesed is a private investment holding company. The wealth came first, and we always meant it to do good. We put it into two things we understand, ',
    subEmphasis: 'software and services',
    subTail: ', and we hold what we buy. Today that means Pipestaff, LokiMode, and Colorado CareAssist.',
    actions: [
  ...
  nameSection: {
    ...
    paragraphs: [
      'In Hebrew, <em>hesed</em> means loving-kindness: a steadfast, covenantal love, measured by what you actually do for another person rather than by what you feel.',
  ...
  approach: {
    kicker: 'Our approach',
    intro: 'Tradition draws a careful line between <em>tzedakah</em>, charity given with money, and <em>gemilut hasadim</em>, the practice of hesed, <strong>given with your hands and your presence.</strong> We are a holding company, not a foundation: we deploy capital and stay to do the work. The tradition says three things about hesed, and they describe how we own a business.',
    principles: [
      { title: 'We own, and we stay.',
        body: 'We are owners, not allocators. We back the operators who run our companies and stay beside them, bringing capital, patience, and work. No financial engineering, no spreadsheet held at arm\'s length.' },
      { title: 'It is owed to everyone it touches.',
  ...
  holdings: {
    ...
    intro: 'We invest where we have operating knowledge, and we hold what we buy. Today Hesed holds three companies: two in software, one in services.',
    rows: [
      {
        tag: { label: 'Software', variant: 'accent' as const },
        company: 'Pipestaff',
        body: 'Exclusive caregiver hiring leads for home care agencies. CNAs, HHAs, and aides, each routed to a single agency, delivered in thirty-plus cities.',
      ...
      },
      {
        tag: { label: 'Software', variant: 'accent' as const },
        company: 'LokiMode',
        body: 'The operating system for a modern home care agency: scheduling, payroll operations, billing, and compliance in one system of record. Built and proven inside Colorado CareAssist, and in early access.',
      ...
      },
      {
        ...
        body: 'A licensed Colorado home care agency. Personal and dementia care, live-in care, care for veterans, and end-of-life support across the Front Range, since 2012.',
  ...
  close: {
    kicker: 'Hesed',
    h2: 'We are doing good, and we intend to keep doing it.',
    buttons: [
